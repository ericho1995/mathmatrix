...
S.q(FI, 'proficient', t`The International Space Station (ISS) orbits Earth at an altitude of 420 km.`, [
  ...
  part('b', t`Calculate the orbital speed of the ISS.`, 2,
    t`7.66 × 10³ m s⁻¹`,
    t`\(v = \sqrt{\frac{GM_E}{r}} = \sqrt{\frac{6.67 \times 10^{-11} \times 5.97 \times 10^{24}}{6.79 \times 10^6}} = 7.66 \times 10^3\) m s⁻¹. 1 mark for the relationship, 1 mark for the value. Common error: using the altitude as the radius.`, { unit: 'm s⁻¹' }),
  part('c', t`Calculate the period of the ISS’s orbit, in minutes.`, 2,
    t`92.9 minutes (accept 92.8)`,
    t`\(T = \frac{2\pi r}{v} = \frac{2\pi \times 6.79 \times 10^6}{7.66 \times 10^3} = 5.57 \times 10^3\) s \(= 92.9\) min (92.8 min from the rounded speed). 1 mark for the period in seconds, 1 mark for minutes.`, { unit: 'minutes' }),
  part('d', t`Calculate the strength of Earth’s gravitational field at the ISS.`, 1,
    t`8.64 N kg⁻¹`,
    t`\(g = \frac{GM_E}{r^2} = 8.64\) N kg⁻¹ — about 88% of its value at Earth’s surface.`, { unit: 'N kg⁻¹' }),
